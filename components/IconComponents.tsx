...
export const TwitterIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9s-1.4-1.3-3.5-2.1c-1.3 1.3-3 2.1-5.2 2.1-4.2 0-7.6-3.4-7.6-7.6s3.4-7.6 7.6-7.6c2.4 0 4.5 1.1 6 2.9z"></path></svg>
);
...
export const FireIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M14.5 4.5c.991.812 1.5 1.832 1.5 3 0 2.21-1.79 4-4 4s-4-1.79-4-4c0-1.168.509-2.188 1.5-3"></path><path d="M12 12.5c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3z"></path><path d="M17.5 12c.991.812 1.5 1.832 1.5 3 0 2.21-1.79 4-4 4s-4-1.79-4-4c0-1.168.509-2.188 1.5-3"></path><path d="M6.5 12c.991.812 1.5 1.832 1.5 3 0 2.21-1.79 4-4 4s-4-1.79-4-4c0-1.168.509-2.188 1.5-3"></path></svg>
);

export const CertificateIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"></path><path d="m9 12 2 2 4-4"></path></svg>
);

export const LightbulbIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2a7 7 0 0 0-7 7c0 2.02 1.02 3.84 2.62 4.94L6.5 17h11l-1.12-3.06A6.992 6.992 0 0 0 19 9a7 7 0 0 0-7-7z"></path><path d="M9 21h6"></path><path d="M12 17v4"></path></svg>
);
