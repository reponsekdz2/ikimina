    ...
    return (
        <div className="space-y-8">
             <div className="grid md:grid-cols-3 gap-6">
                <StatCard icon={<BriefcaseIcon className="w-8 h-8 text-[#1E90FF]"/>} label="Applied Jobs" value="5" />
                <StatCard icon={<BookOpenIcon className="w-8 h-8 text-[#32CD32]"/>} label="Trainings Completed" value="2" />
                <StatCard icon={<UsersIcon className="w-8 h-8 text-[#FFD700]"/>} label="Community Posts" value="1" />
             </div>
